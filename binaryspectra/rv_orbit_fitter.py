...
@numba.jit(nopython=True)
def rv_model(t, K, gamma, phi0, ecc, omega, period):
...
@numba.jit(nopython=True)
def lnprior_sb1(theta, t, period_mu=None, period_sigma=None, ecc_max=None, period_max=3000):
...
def lnprob_sb2(theta, t, rv1, rv_err1, rv2, rv_err2, 
    ...
    lp = lnprior_sb2(theta, t, period_mu=period_mu, period_sigma=period_sigma, ecc_max=ecc_max)
